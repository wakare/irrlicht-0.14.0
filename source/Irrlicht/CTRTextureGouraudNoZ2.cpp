...
class CTRTextureGouraudNoZ2 : public CTRTextureLightMap2_M1
{
public:

	//! constructor
	CTRTextureGouraudNoZ2(IZBuffer2* zbuffer);
...
//! constructor
CTRTextureGouraudNoZ2::CTRTextureGouraudNoZ2(IZBuffer2* zbuffer)
: CTRTextureLightMap2_M1(0)
{
	#ifdef _DEBUG
...
/*!
*/
inline void CTRTextureGouraudNoZ2::scanline_bilinear ( sScanLineData * data ) const
{
	u16 *dst;
