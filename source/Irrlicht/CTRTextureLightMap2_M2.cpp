...
class CTRTextureLightMap2_M2 : public CTRTextureLightMap2_M1
{
public:

	//! constructor
	CTRTextureLightMap2_M2(IZBuffer2* zbuffer);
...
//! constructor
CTRTextureLightMap2_M2::CTRTextureLightMap2_M2(IZBuffer2* zbuffer)
: CTRTextureLightMap2_M1(zbuffer)
{
	#ifdef _DEBUG
...
/*!
*/
inline void CTRTextureLightMap2_M2::scanline_bilinear ( sScanLineData * data ) const
{
	u16 *dst;
	...
	for ( s32 i = 0; i <= dx; ++i )
	{
...
#endif
		{
			...
			r2 = clampFix31 ( imulFix2 ( r0, r1 ) );
			g2 = clampFix31 ( imulFix2 ( g0, g1 ) );
			b2 = clampFix31 ( imulFix2 ( b0, b1 ) );
