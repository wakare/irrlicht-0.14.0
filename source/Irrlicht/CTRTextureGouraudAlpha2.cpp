...
class CTRTextureGouraudAlpha2 : public CTRTextureLightMap2_M1
{
public:

	//! constructor
	CTRTextureGouraudAlpha2(IZBuffer2* zbuffer);
...
//! constructor
CTRTextureGouraudAlpha2::CTRTextureGouraudAlpha2(IZBuffer2* zbuffer)
...
/*!
*/
inline void CTRTextureGouraudAlpha2::scanline_bilinear ( sScanLineData * data ) const
{
	u16 *dst;
	...
	for ( s32 i = 0; i <= dx; ++i )
	{
...
#endif
		{
			...
			getFixPoint_A1R5G5B5 ( r1, g1, b1, dst[i] );

			dst[i] = getA1R5G5B5 ( r0, g0, b0 );
