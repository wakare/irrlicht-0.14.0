...
class CTRTextureLightMap2_M4 : public CTRTextureLightMap2_M1
{
public:

	//! constructor
	CTRTextureLightMap2_M4(IZBuffer2* zbuffer);
...
//! constructor
CTRTextureLightMap2_M4::CTRTextureLightMap2_M4(IZBuffer2* zbuffer)
...
inline void CTRTextureLightMap2_M4::scanline_bilinear ( sScanLineData * data ) const
{
	...
	for ( s32 i = 0; i <= dx; ++i )
	{
...
#endif
		{
			...
			r2 = clampFix31 ( imulFix3 ( r0, r1 ) );
			g2 = clampFix31 ( imulFix3 ( g0, g1 ) );
			b2 = clampFix31 ( imulFix3 ( b0, b1 ) );
